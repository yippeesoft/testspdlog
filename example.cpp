...
// Using a namespace alias like fmt_lib is not allowed when extending an
// existing namespace, but the correct namespace can still be selected with the
// SPDLOG_USE_STD_FORMAT macro.
...
replace_default_logger_example()
{
  ...
  auto new_logger = spdlog::basic_logger_mt(
    "new_default_logger", "logs/new-default-log.txt", true);
